...
class AdapterCommonForThree(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is FollowViewHolder -> {
                ...
                holder.TextViewText?.text = arrFollowNLike?.get(position)?.profile_status
    ...
    inner class FollowViewHolder constructor(view: View) :
        ...
        var TextViewText: TextView = view.findViewById(R.id.textViewDesc)
        ...
        init {
            ...
            layoutItem.setOnClickListener {
                onFollowLikeListener?.onProfileClicking(adapterPosition)
            }
    ...
    interface OnFllowLikeListner {
        ...
        fun onProfileClicking(position: Int)
    }
}