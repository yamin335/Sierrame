...
public class LiveActivityDemo extends RtcBaseActivity {
    private static final String TAG = LiveActivityDemo.class.getSimpleName();
    ...
    public BeautyOptions DEFAULT_BEAUTY_OPTIONS = new BeautyOptions(
            AppConstants.BEAUTY_EFFECT_DEFAULT_CONTRAST,
            AppConstants.BEAUTY_EFFECT_DEFAULT_LIGHTNESS,
            AppConstants.BEAUTY_EFFECT_DEFAULT_SMOOTHNESS,
            AppConstants.BEAUTY_EFFECT_DEFAULT_REDNESS);
    ...
    private void initUserIcon() {
        Bitmap origin = BitmapFactory.decodeResource(getResources(), R.drawable.ic_delete);
